...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  callTextProvider: (provider, apiKey, model, prompt) => electron.ipcRenderer.invoke("ai:callTextProvider", provider, apiKey, model, prompt),
  // FFmpeg operations
